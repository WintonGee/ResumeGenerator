...
public class ExperienceInitializer {
    public static List<Experience> initializeExperiences() {
        ...
        DynamicSentence legacyCodeSentence = new DynamicSentence("Refactored legacy backend code, reducing technical debt by 10% and improving code maintainability");
        ...
        DynamicSentence responsiveDesignSentence = new DynamicSentence("Implemented responsive design principles, ensuring the app works seamlessly across devices and screen sizes");
        ...
        DynamicSentence userFeedbackSentence = new DynamicSentence("Incorporated user feedback into design iterations, improving user satisfaction by 25%");
        DynamicSentence agileMethodologySentence = new DynamicSentence("Applied Agile methodologies, completing all project sprints on time and within budget");
